...
type User struct {
	ID           int            `gorm:"primary_key:auto_increment" json:"id" gorm:"column:beast_id"`
	...
	UserTypeID   int            `gorm:"type:int4" gorm:"foreignKey:UserTypeID" json:"user_type_id" gorm:"column:user_type_id"`
